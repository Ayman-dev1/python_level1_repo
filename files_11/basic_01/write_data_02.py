...
my_file_reference = open('D:\\courses to learn\\Python Backend (senior steps)\\my_files\\write_data.txt', 'w')
...
with  open('D:\\courses to learn\\Python Backend (senior steps)\\my_files\\write_data.txt', 'a') as my_file_reference:
